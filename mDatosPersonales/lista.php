...
<table id="example<?php echo $varGral;?>" class="table table-striped table-bordered" style="width:100%">
        ...
        while( $row = mysqli_fetch_array($consultar) ) {
            ...
            if ($turno == NULL) {
                $icoHorario = "<i class='fas fa-file-excel fa-lg'></i>";
                $tHorario="No";
            }
            else{
                $icoHorario = "<i class='fas fa-clipboard-check fa-lg'></i>";
                $tHorario="Si";
            }
            ...
            <tr class="centrar">
                ...
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="horario btn btn-outline-dark btn-sm activo"  id="btnHorario<?php echo $varGral?><?php echo $n?>" onclick="abrirModalHorario('<?php echo $id?>','<?php echo $nCompleto?>','<?php echo $turno?>','<?php echo $L_entrada?>','<?php echo $L_salida?>','<?php echo $Ma_entrada?>','<?php echo $Ma_salida?>','<?php echo $Mi_entrada?>','<?php echo $Mi_salida?>','<?php echo $J_entrada?>','<?php echo $J_salida?>','<?php echo $V_entrada?>','<?php echo $V_salida?>','<?php echo $S_entrada?>','<?php echo $S_salida?>','<?php echo $D_entrada?>','<?php echo $D_salida?>','<?php echo $tHorario?>')">
                        <?php echo $icoHorario?>
                    </button> 
                </td>
                <td>
