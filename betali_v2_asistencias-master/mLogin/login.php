        ...
        <form action="verificar_login.php" method="post" id="frmLogin" style="border-color:#40739e">
            ...
            <input type="password" id="loginContra" class="form-control" placeholder="Escribe la contraseña" required>
                ...
                <div class="col text-center">
                    <button type="submit" class="btn btn-outline-dark btn-block active" id="btnIngresar" disabled>
                        <i class="fas fa-lock" id="icoLogin"></i>
                        Ingresar al sistema
                    </button>
                </div><br>
                <div class="col text-center">
                    <button class="btn btn-outline-info btn-block" data-toggle="modal" data-target="#modalContra">
                        <i class="fas fa-key" id="icoContra"></i>
                        Cambiar contraseña
                    </button>
                </div>
        </form>
