...
<table id="example<?php echo $varGral;?>" class="table table-striped table-bordered" style="width:100%">
        ...
        while( $row = mysqli_fetch_array($consultar) ) {
            ...
            if ($row[1] == 1) {
                ...
                $dtnDesabilita = "";
                $chkValor      = "1";
                $icoContra     = "fas fa-sync fa-spin fa-lg";
                $icoPermisos   = "fas fa-key fa-lg";
            }else{
                $chkChecado    = "";
                $dtnDesabilita = "disabled";
                $chkValor      = "0";
                $icoContra     = "fas fa-sync fa-lg";
                $icoPermisos   = "fas fa-lock fa-lg";
            }
            ...
            <tr class="centrar">
                ...
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="restablecer btn btn-outline-warning btn-sm activo" id="btnContra<?php echo $varGral?><?php echo $n?>" onclick="rContra('<?php echo $id?>')">
                        <i id="icoContra<?php echo $varGral?><?php echo $n?>" class="<?php echo $icoContra?>"></i>
                    </button>
                </td>
                <td style="width:15%;">
                    <button <?php echo $dtnDesabilita?> type="button" class="permisos btn btn-outline-info btn-sm activo"  id="btnPermisos<?php echo $varGral?><?php echo $n?>" onclick="abrirModalPermisos('<?php echo $id?>','<?php echo $nom_persona?>','<?php echo $p_datos_persona?>','<?php echo $p_ecivil?>','<?php echo $p_usuario?>', '<?php echo $p_temas?>')">
                        <i id="icoPermisos<?php echo $varGral?><?php echo $n?>" class="<?php echo $icoPermisos?>"></i>
                    </button>
                </td>
                <td style="width:25%;">
                    <label class="textoBase">
                        <?php echo $nom_persona?>       
                    </label>
                </td>
                <td>
                    <label class="textoBase">
                ...
                <td style="width:25%;">
                    <label class="textoBase">
                        <strong>Creado desde hace: </strong> <?php echo $dias?>  
                    </label>
                </td>
                <td style="width= 25px;">
